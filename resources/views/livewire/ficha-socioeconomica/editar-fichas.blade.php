        ...
        <form class="w-full" wire:submit.prevent='crearFicha'>
            ...
            <div class="grid grid-cols-4 gap-3 p-3 border border-sky-500 rounded-lg mb-3 bg-sky-50">
                ...
                <div>
                    ...
                    <input id="apellidoPat" class="block mt-1 w-full" type="text" wire:model="apellidoPat"
                ...
                <div>
                    ...
                    <input id="apellidoMat" class="block mt-1 w-full" type="text" wire:model="apellidoMat"
                ...
                <div>
                    ...
                    <input id="codigo" class="block mt-1 w-full" type="text" wire:model="codigo"
                ...
                <div>
                    ...
                    <select id="escuela" wire:model="escuela"
                        ...
                        @foreach ($escuelas as $d)
                            <option value="{{ $d->id }}">{{ $d->nombre_escuela }}</option>
                        @endforeach
                    </select>
                    @error('escuela')
                        <livewire:mostrar-alerta :message="$message" />
                ...
                <div>
                    ...
                    <input id="direccion" class="block mt-1 w-full" type="text" wire:model="direccion"
                ...
                <div>
                    ...
                    <input id="dir" class="block mt-1 w-full " type="text" wire:model="dir"
                ...
                <div>
                    ...
                    <input id="tel" class="block mt-1 w-full" type="text" wire:model="tel"
